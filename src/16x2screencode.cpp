...
void loop_old() {
  ...
  if (command == 0) {
    ...
    while (command == 0) {
      lcdSetCursor(0,
                   0); // Move the cursor to column 0, row 0 (top-left corner)
      ...
      lcdSetCursor(0,
                   1); // Move the cursor to column 0, row 0 (top-left corner)
  ...
  if (command == 2) {
    ...
    while (command == 2) {
      lcdSetCursor(0,
                   0); // Move the cursor to column 0, row 0 (top-left corner)
      lcdPrint(
          "DOUBLE"); // Print text to the LCD at the current cursor position
  ...
  if (command == 4) {
    ...
    while (command == 4) {
      lcdSetCursor(0,
                   0); // Move the cursor to column 0, row 0 (top-left corner)
      lcdPrint(
          "SURRENDER"); // Print text to the LCD at the current cursor position
    ...
    while (command == -1) {
      ...
      for (int j = 0; j < 4 && command == -1;
           j++) {           // Stop early if button pressed
        ...
        if (command != -1)
          break; // exit early if a button was pressed
        //----------------------------------------------------------------
